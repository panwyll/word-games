...
import { SPELLING_BEE_PUZZLES } from '@/lib/spelling-bee-puzzles';
...
export default function SpellingBeeGame() {
  const puzzle: SpellingBeePuzzle = SPELLING_BEE_PUZZLES[getDailyIndex(SPELLING_BEE_PUZZLES.length)];
